...
export const mockRfqs: CharterRFQ[] = [
    ...
    { id: 'RFQ-792', customerId: 'customer-user-02', requesterExternalAuthId: 'customer-user-02', customerName: 'Arjun Mehta', tripType: 'Onward', departure: 'Kolkata (CCU)', arrival: 'Bagdogra (IXB)', departureDate: '2024-08-20', pax: 8, aircraftType: 'Any', status: 'Bidding Closed', createdAt: '2024-07-26T10:00:00Z', bidsCount: 2 },
    { id: 'RFQ-793', customerId: 'customer-user-01', requesterExternalAuthId: 'customer-user-01', customerName: 'Sanjana Kumar', tripType: 'Onward', departure: 'Pune (PNQ)', arrival: 'Ahmedabad (AMD)', departureDate: '2024-09-01', pax: 3, aircraftType: 'Any Light Jet', status: 'Operator Selected', createdAt: '2024-07-29T09:00:00Z', bidsCount: 4 },
];
...
export const mockQuotations: Quotation[] = [
    ...
    { id: 'QTE-113', rfqId: 'RFQ-789', operatorId: 'operator-user-01', operatorName: 'FlyCo Charter', aircraftId: 'AC-VTSKY', aircraftName: 'King Air 350', price: 650000, status: 'Withdrawn', submittedAt: '2024-07-28T13:00:00Z', validUntil: '2024-07-29T13:00:00Z' },
    ...
    { id: 'QTE-115', rfqId: 'RFQ-793', operatorId: 'operator-user-01', operatorName: 'FlyCo Charter', aircraftId: 'AC-VTFLY', aircraftName: 'Phenom 300E', price: 700000, status: 'Selected', submittedAt: '2024-07-29T10:00:00Z', validUntil: '2024-07-30T10:00:00Z' },
];
...
export const mockEmptyLegs: EmptyLeg[] = [
    ...
    { id: 'EL-903', operatorId: 'operator-user-02', aircraftId: 'AC-VTJET', departure: 'Hyderabad (HYD)', arrival: 'Chennai (MAA)', departureTime: '2024-08-09T18:00:00Z', availableSeats: 5, status: 'Expired' },
];

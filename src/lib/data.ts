...
export const rfqs: CharterRFQ[] = [
  ...
  { id: 'rfq_2', customerId: 'usr_6', customerName: 'Rohan Mehta (Tata Steel)', tripType: 'Return', departure: 'Jamshedpur (VEJS)', arrival: 'Kolkata (VECC)', departureDate: format(addDays(new Date(), 3), 'yyyy-MM-dd'), returnDate: format(addDays(new Date(), 5), 'yyyy-MM-dd'), pax: 3, aircraftType: 'Any Turboprop', status: 'Pending Approval', createdAt: format(subDays(new Date(), 2), 'yyyy-MM-dd HH:mm'), bidsCount: 0, businessPurpose: 'Quarterly Review Meeting', costCenter: 'FIN-CORP-2024' },
...
export const auditLogs: AuditLog[] = [
  ...
  { id: 'log_4', timestamp: format(subDays(new Date(), 2), 'yyyy-MM-dd HH:mm:ss'), user: 'Rohan Mehta', role: 'CTD Admin', action: 'Created RFQ', details: 'RFQ from Jamshedpur to Kolkata for 3 pax on behalf of Tata Steel', targetId: 'rfq_2' },
  { id: 'log_5', timestamp: format(subDays(new Date(), 2), 'yyyy-MM-dd HH:mm:ss'), user: 'System', role: 'Admin', action: 'Forwarded for Approval', details: 'RFQ requires approval from CTD Admin', targetId: 'rfq_2' },
];

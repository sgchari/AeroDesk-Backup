  ...
  return (
    <div className="w-full max-w-7xl mx-auto">
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
        ...
        <div className="bg-black/50 p-4 rounded-lg shadow-2xl">
          <TabsContent value="jet">
              <div className="space-y-4">
                  ...
                  {tripType === 'round' && (
                       <div className="space-y-4">
                          <div className="grid grid-cols-1 md:grid-cols-7 items-stretch rounded-md overflow-hidden bg-white gap-px">
                              <AutocompleteInput placeholder="Origin" value={origin} onChange={setOrigin} />
                              <AutocompleteInput placeholder="Destination" value={destination} onChange={setDestination} />
                              <Input
                                  type="text"

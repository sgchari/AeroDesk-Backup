...
export function BookingWidget() {
  ...
  return (
    <div className="w-full max-w-5xl mx-auto bg-background/50 backdrop-blur-md rounded-xl shadow-lg border border-border p-4 sm:p-6">
        <Tabs defaultValue="jet" className="w-full">
            <TabsList className="flex justify-center bg-transparent p-0 rounded-lg max-w-md mx-auto">
                <TabsTrigger value="jet" className="text-muted-foreground data-[state=active]:text-primary-foreground data-[state=active]:bg-primary data-[state=active]:shadow-lg p-3 rounded-md flex items-center justify-center gap-2 text-sm sm:text-base">
                    <Plane /> JET
                </TabsTrigger>
                <TabsTrigger value="helicopter" className="text-muted-foreground data-[state=active]:text-primary-foreground data-[state=active]:bg-primary data-[state=active]:shadow-lg p-3 rounded-md flex items-center justify-center gap-2 text-sm sm:text-base">
                    <Helicopter /> HELICOPTER
                </TabsTrigger>
                 <TooltipProvider>
                    <Tooltip>
                        <TooltipTrigger asChild>
                             <TabsTrigger value="seats" className="text-muted-foreground data-[state=active]:text-primary-foreground data-[state=active]:bg-primary data-[state=active]:shadow-lg p-3 rounded-md flex items-center justify-center gap-2 text-sm sm:text-base">
                ...
                <div className="space-y-6">
                    <RadioGroup value={tripType} onValueChange={handleTripTypeChange} className="flex items-center justify-center gap-4 sm:gap-6">
                        <div className="flex items-center space-x-2">
                            <RadioGroupItem value="oneway" id="oneway" className="border-primary" />
                            <Label htmlFor="oneway" className="text-foreground text-sm sm:text-base">Oneway</Label>
                        </div>
                        <div className="flex items-center space-x-2">
                            <RadioGroupItem value="round" id="round" className="border-primary" />
                            <Label htmlFor="round" className="text-foreground text-sm sm:text-base">Round</Label>
                        </div>
                        <div className="flex items-center space-x-2">
                            <RadioGroupItem value="multicity" id="multicity" className="border-primary" />
                            <Label htmlFor="multicity" className="text-foreground text-sm sm:text-base">Multicity</Label>
                        </div>
                    </RadioGroup>

                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                    <div className="flex items-center gap-2">
                        ...
                        <div>
                            ...
                            <CardDescription className="text-[10px] text-muted-foreground uppercase">Real-time network situational awareness</CardDescription>
                        </div>
                    </div>
                    <Badge variant="outline" className="font-code text-[9px] sm:text-[10px] text-accent border-accent/20 bg-accent/5 w-fit">
                        ...
                        {liveMissions.length > 3 && (
                            <div className="text-center p-2 rounded bg-muted/10 border border-white/5">
                                <p className="text-[9px] text-muted-foreground uppercase font-bold tracking-widest">
                                    + {liveMissions.length - 3} Additional Missions
                                </p>
                            </div>
                        )}
                    </div>

...
const AeroLogoIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg viewBox="0 0 50 50" xmlns="http://www.w3.org/2000/svg" {...props}>
        ...
        <g transform="translate(25 25) rotate(-15)">
            <path d="M 0 -4 C 8 -11, 8 -20, 2 -24 L -2 -24 C -8 -20, -8 -11, 0 -4 Z" transform="rotate(0 0 0)" fill="hsl(var(--primary))" />
            <path d="M 0 -4 C 8 -11, 8 -20, 2 -24 L -2 -24 C -8 -20, -8 -11, 0 -4 Z" transform="rotate(120 0 0)" fill="hsl(var(--primary))" />
            <path d="M 0 -4 C 8 -11, 8 -20, 2 -24 L -2 -24 C -8 -20, -8 -11, 0 -4 Z" transform="rotate(240 0 0)" fill="hsl(var(--primary))" />
        </g>
...
export function Logo({ className }: { className?: string }) {
  return (
    <div className={cn("flex items-center gap-3 group", className)}>
        <div className={cn("p-1.5 rounded-full border-2 border-primary/80 bg-background")}>
            <AeroLogoIcon

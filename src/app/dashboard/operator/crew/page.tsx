...
import { MoreHorizontal, PlusCircle, User, Plane, CheckCircle2, AlertCircle, Clock, ShieldCheck } from "lucide-react";
...
export default function CrewManagementPage() {
    ...
    return (
        <>
            <PageHeader title="Crew & Logistics Control" description="Manage flight deck personnel, track duty cycles, and maintain operational readiness.">
            ...
            <div className="grid gap-6">
                <Card className="bg-card">
                    <CardHeader>
                        ...
                        <CardDescription>
                            A comprehensive log of all crew members and their current deployment status.
                        </CardDescription>
                    </CardHeader>
                    <CardContent>
                            ...
                            <Table>
                                <TableHeader>
                                    <TableRow>
                                        ...
                                        <TableHead>Role & Certification</TableHead>
                                        ...
                                        <TableRow key={member.id} className="group">
                                            ...
                                            <TableCell>
                                                <div className="space-y-1">
                                                    ...
                                                    <p className="text-[10px] text-muted-foreground font-code">{member.licenseNumber || 'PENDING'}</p>
                                                </div>
                                            </TableCell>
                                            <TableCell>
                                                <div className="flex items-center gap-2">
                                                    <Plane className="h-3.5 w-3.5 text-accent/60" />
                                                    <span className="text-xs font-medium">{member.assignedAircraftRegistration || 'FLOAT'}</span>
                                                </div>
                                            </TableCell>
                                            <TableCell>
                                            ...
                                            <TableCell className="text-right">
                                                <DropdownMenu>
                                                    ...
                                                    <DropdownMenuContent align="end">
                                                        <DropdownMenuLabel>Duty Controls</DropdownMenuLabel>
                                                        ...
                                                        <DropdownMenuItem className="gap-2">
                                                            <ShieldCheck className="h-3.5 w-3.5" /> Compliance Audit
                                                        </DropdownMenuItem>
                                                        <DropdownMenuItem className="gap-2 text-destructive">
                                                            <AlertCircle className="h-3.5 w-3.5" /> Revoke Certification
                                                        </DropdownMenuItem>
                                                    </DropdownMenuContent>
                                                </DropdownMenu>
                                            </TableCell>
                        ...
                        {(!isLoading && (!crew || crew.length === 0)) && (
                            <div className="text-center py-20 border-2 border-dashed rounded-lg bg-muted/5">
                                ...
                                <p className="text-muted-foreground font-medium">No personnel registered.</p>
                                <Button variant="link" onClick={() => setIsAddOpen(true)} className="text-accent text-xs">Initialize Crew Registry</Button>
                            </div>
                        )}
                    </CardContent>
                </Card>

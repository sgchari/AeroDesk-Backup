...
export default function OperatorUserManagementPage() {
    ...
    const handleRoleChange = (userId: string, newRole: FirmRole) => {
        ...
        toast({ title: "Privileges Updated", description: `User role has been set to ${newRole}.` });
    };
        ...
        <div className="space-y-6">
            ...
            <Card className="bg-card border-white/5">
                <CardHeader>
                    ...
                    <CardDescription>A centralized log of all users with mission-level clearance.</CardDescription>
                </CardHeader>
                <CardContent>
                                            ...
                                            {isAdmin && member.id !== currentUser?.id && (
                                                <DropdownMenu>
                                                    ...
                                                    <DropdownMenuContent align="end">
                                                        <DropdownMenuLabel>Firm Governance</DropdownMenuLabel>
                                                        ...
                                                        <DropdownMenuItem onClick={() => handleRoleChange(member.id, 'operations')}>Set Ops Lead</DropdownMenuItem>

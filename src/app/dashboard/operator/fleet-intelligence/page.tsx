            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                <Card className="bg-card">
                    <CardHeader className="pb-2">
                        <CardTitle className="text-xs uppercase text-muted-foreground font-black">Fleet Utilization</CardTitle>
                    </CardHeader>
                    <CardContent>
                        <div className="text-2xl font-black text-white">{stats.avgUtil}%</div>
                        <p className="text-[10px] text-emerald-500 font-bold uppercase mt-1">Optimal Performance</p>
                    </CardContent>
                </Card>
                <Card className="bg-card">
                    <CardHeader className="pb-2">
                        <CardTitle className="text-xs uppercase text-muted-foreground font-black">Air-time (MTD)</CardTitle>
                    </CardHeader>
                    <CardContent>
                        <div className="text-2xl font-black text-white">{stats.totalHours} hrs</div>
                        <p className="text-[10px] text-sky-500 font-bold uppercase mt-1">Logged Fleet Hours</p>
                    </CardContent>
                </Card>
                <Card className="bg-card">
                    <CardHeader className="pb-2">
                        <CardTitle className="text-xs uppercase text-muted-foreground font-black">AOG Events</CardTitle>
                    </CardHeader>
                    <CardContent>
                        <div className="text-2xl font-black text-white">{stats.aogCount}</div>
                        <p className="text-[10px] text-rose-500 font-bold uppercase mt-1">Attention Required</p>
                    </CardContent>
                </Card>
                <Card className="bg-card">
                    <CardHeader className="pb-2">
                        <CardTitle className="text-xs uppercase text-muted-foreground font-black">Revenue Intensity</CardTitle>
                    </CardHeader>
                    <CardContent>
                        <div className="text-2xl font-black text-accent">₹ 4.2 Cr</div>
                        <p className="text-[10px] text-accent/60 font-bold uppercase mt-1">Platform GSV</p>
                    </CardContent>
                </Card>
            </div>
                    ...
                    <Card className="bg-primary/5 border-primary/20">
                        ...
                        <CardContent className="space-y-3 pt-2">
                            <div className="flex items-center justify-between p-2 rounded bg-black/40 border border-white/5">
                                <span className="text-[10px] font-bold text-white uppercase">VT-PC (King Air)</span>
                                <Badge variant="outline" className="text-[8px] text-amber-500 border-amber-500/30">DUE 12 DAYS</Badge>
                            </div>

      ...
      <div className="relative z-10 flex min-h-screen flex-col bg-transparent">
        ...
        <main className="flex-1 py-12 md:py-16">
          <div className="container">
            <Card className="border-white/10 bg-black/15 backdrop-blur-md text-white overflow-hidden">
                <CardHeader>
                    <div className="flex justify-between items-center">
                        <div>
                            <CardTitle className="text-3xl font-headline">Operator Network</CardTitle>
                            <CardDescription>Live status of all approved operators.</CardDescription>
                        </div>
                     ...
                     {isLoading ? (
                        ...
                        <div className="relative aspect-video w-full">
                            ...
                            {Object.entries(zoneLabels).map(([zone, position]) => (
                                <div
                                    key={zone}
                                    className="absolute z-20 px-4 py-1 rounded-full text-xs font-bold tracking-wider uppercase text-white/80 bg-black/20 backdrop-blur-sm border border-white/10 shadow-lg"
                                    style={{ top: position.top, left: position.left, transform: 'translate(-50%, -50%)' }}
                                >
                                    {zone}
                                </div>

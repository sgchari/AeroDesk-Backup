        ...
        <main className="flex-1 py-12 md:py-16 flex items-center justify-center">
          <div className="container flex items-center justify-center">
            <Card className="border-white/10 bg-black/15 backdrop-blur-md text-white w-full max-w-2xl">
                <CardHeader>
                    <CardTitle className="text-3xl font-headline text-center">Our Network</CardTitle>
                </CardHeader>
                <CardContent className="text-center">
                    <p className="text-white/80">Information about our network of operators and partners will be available here soon.</p>
                </CardContent>
            </Card>
          </div>
        </main>

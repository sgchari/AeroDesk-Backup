...
export default function OurNetworkPage() {
    ...
    return (
        <div className="w-full bg-[#0D1B2A] min-h-screen text-[#EAEAEA]">
            ...
            <main className="relative flex flex-col lg:flex-row h-full min-h-[calc(100vh-80px)] overflow-hidden">
                ...
                <div className="w-full lg:w-[30%] p-6 lg:p-10 z-20 flex flex-col gap-8 bg-black/20 backdrop-blur-3xl border-r border-white/5">
                ...
                <div className="relative flex-1 bg-[#1B263B] overflow-hidden flex items-center justify-center">
                    {/* Grid Overlay */}
